...
export function DownloadButton({ svg, fileName, disabled }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        "group inline-flex items-center gap-2 rounded px-2.5 py-2 text-[12px] font-medium tracking-wide transition-all sm:px-3.5",
        isDisabled
    ...
    >
      ...
      <span className="hidden sm:inline">SVG をダウンロード</span>
      <span
        className={cn(
          "hidden rounded px-1.5 py-0.5 font-mono text-[9px] lg:inline",
